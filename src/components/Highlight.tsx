...
const Highlight = () => {
  ...
  return (
    <div className="relative w-full h-screen background-gradient-dark flex items-center justify-center overflow-hidden min-h-screen">
      <div
        ref={svgRef}
        className="absolute inset-0 opacity-0 topographic-map mix-blend-overlay"
      >
        <img
          src="/assets/topographic-map.webp"
          alt="Topographic map"
      ...
      >
        <p ref={titleRef} className="eyebrow text-light mb-5 opacity-0">
        ...
        <div className="mt-8">
          <a
            href="https://docsend.com/view/uxqeax4p2jdwtbgn"
            target="_blank"
          ...
          >
            <button className="btn-secondary transition-all duration-200 group">
              <div className="flex items-center gap-2 px-4">
                <svg
                  className="w-6 h-6 transition-colors duration-200 group-hover:[&>path]:stroke-[var(--color-light)]"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <span className="button-text text-secondary group-hover:text-light transition-colors duration-200">
                  {t("menu.downloadTwoPager")}
                </span>
              </div>
            </button>
          </a>
