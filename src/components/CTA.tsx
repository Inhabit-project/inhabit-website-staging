...
const CTA: React.FC = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 flex min-h-screen items-center justify-center px-[clamp(1.5rem,5vw,6.25rem)]">
        <div className="w-full max-w-[120rem] rounded-[20px] overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className=" grid  p-8 md:p-12  w-[70%] bg-secondary/80 backdrop-blur-[18.9px] content-center content-between">
              <h3 className="heading-3 text-light">
              ...
              <div className="mt-12 flex flex-wrap gap-4">
                {/* Primary Button */}
                <button className="h-[4.375rem] bg-primary hover:bg-primary/90 backdrop-blur-[6px] rounded-button flex items-center group transition-colors">
                ...
                {/* Secondary Button */}
                <button className="h-[4.375rem] bg-green-soft hover:bg-green-soft/90 backdrop-blur-[6px] rounded-button flex items-center group transition-colors">
                  <div className="flex items-center gap-2 px-6">
                  ...
                  <div className="flex items-center px-4 border-l border-secondary/20">
