    ...
    <div className="w-full">
      ...
      <section className="relative w-full">
        <div className="relative w-full aspect-[16/9]">
          ...
          <div className="absolute top-[clamp(1.5rem,5vw,6.25rem)] right-[clamp(1.5rem,5vw,6.25rem)] max-w-[40rem] bg-secondary/80 backdrop-blur-[18.9px] p-8 rounded-[20px]">
      ...
      <section className="relative w-full">
        <div className="relative w-full aspect-[16/9]">
          ...
          <div className="absolute top-[clamp(1.5rem,5vw,6.25rem)] left-[clamp(1.5rem,5vw,6.25rem)] max-w-[40rem] bg-secondary/80 backdrop-blur-[18.9px] p-8 rounded-[20px]">
            <p className="body-M text-light">
