...
const ContactPage: React.FC<ContactPageProps> = ({ onPageReady }) => {
  ...
  return (
    <div ref={mainRef} className="min-h-screen background-gradient-light">
      ...
      <Menu />
      <main className="w-full flex flex-col items-center justify-center py-20 md:py-32 pt-32 background-gradient-light flex-1" aria-labelledby="contact-title">
        <div className="w-full max-w-[120rem] mx-auto px-[clamp(1.5rem,5vw,6.25rem)] flex-1 flex flex-col">
          ...
          <div className="w-full flex flex-col md:flex-row gap-12 md:gap-24 items-start justify-between flex-1">
            {/* Left Info Section */}
